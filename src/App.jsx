...
class App extends React.Component {
  constructor(props){
    ...
    this.state = {
      ...
      accounts: s.all('Accounts'),
      transactions: s.all('Transactions'),
      categories: s.all('Categories'),
      groups: s.all('Groups'),
      budgets: s.all('Budgets'),
    };
    this.accountTypes = [
