...
class App extends React.Component {
  constructor(props){
    ...
    this.state = {
      ...
      dash: { tab:'networth', range:'6m', accountId:'', groupId:'', categoryId:'' },
  ...
  buildViewModel(){
    ...
    const dashRangeBtns = [['3m','3M'],['6m','6M'],['12m','1A'],['ytd','YTD'],['all','Tutto']].map(x => ({
