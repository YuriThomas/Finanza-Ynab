...
class App extends React.Component {
  ...
  resetData(){ if(window.confirm('Ripristinare i dati d\u2019esempio? Le tue modifiche andranno perse.')){ this.store.reset(); this.setState({ month:'2026-07', filters:{from:'',to:'',accountId:'',categoryId:'',type:''} }); this.refresh(); } }
  ...
  buildViewModel(){
    ...
    const incomeThisMonth = monthTxns.filter(t=>t.type==='Income' && (accMap[t.accountId] ? accMap[t.accountId].onBudget!==false : true)).reduce((s,t)=>s+t.amount,0);
    const ready = incomeThisMonth - totalAssigned;
