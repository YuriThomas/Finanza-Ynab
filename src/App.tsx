...
class App extends React.Component {
  ...
  buildViewModel(){
    ...
    const readyDebugCash = this.onBudgetCash();
    const readyDebugText = 'Liquidità conti: '+this.fmtEur(readyDebugCash)+'  ·  Nelle categorie: '+this.fmtEur(totalAvail);
